...
class Media {
  constructor() {
    ...
    require('../media/files/imageArRGB.png')
    require('../media/files/imageArBWNum.png')
    require('../media/files/mosaicRGB.png')
    require('../media/files/mosaic.png')
    require('../media/files/imageArBW.png')
    require('../media/files/lucid.png')
    require('../media/files/elephant.png')
    require('../media/files/numbersets.png')
    require('../media/files/confusedscream.png')
    require('../media/files/virginchaduni.png')
    require('../media/files/settle.png')
    require('../media/files/means.png')
    require('../media/files/tsunamis.png')
    require('../media/files/normal.png')
    require('../media/files/algalon.png')
